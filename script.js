...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const RELATIONSHIP_START = new Date('2021-08-27T00:00:00');

  const LOVE_MESSAGES = [
    'I love you, Trisha 💜', 'You are my everything ❤️', 'Forever us 💕',
    'My heart is yours 💖', 'You are so cute 🥰', 'My favourite person ✨',
    'Happy Anniversary 🌸', 'Forever yours 💫', 'You are my happiness 🦋', 'Kaju paneer nights 🌹'
  ];

  const LYRICS = [
    { time: 30.0, text: "Watching the sunrise on the coastline," },
    { time: 33.9, text: "While we both get older." },
    { time: 37.5, text: "I can't describe what I'm feeling," },
    { time: 41.6, text: "And all I know is we're going home." },
    ...
    { time: 60.7, text: "As long as I'm with you," },
    { time: 64.2, text: "I've got a smile on my face." },
    { time: 68.1, text: "Save your tears, it'll be okay," },
    { time: 72.1, text: "All I know is you're here with me." },
    { time: 79.9, text: "Looking at the sunrise as we grow old, oh-oh..." },
    { time: 87.7, text: "I can't describe, oh-oh..." },
    { time: 91.8, text: "I wish I could relive every memory of you" },
    { time: 95.5, text: "One more time before you blow away with the wind." },
    { time: 99.5, text: "And all that time we spent," },
    { time: 103.3, text: "Waiting for the light to take us in," },
    { time: 107.2, text: "Were the best moments of my life." },
    { time: 111.0, text: "I don't care how long it takes," },
    { time: 118.7, text: "As long as I'm with you," },
    { time: 122.3, text: "I've got a smile on my face." },
    { time: 126.1, text: "It'll be okay, just don't cry," },
    { time: 130.2, text: "Because you're here, you're with me..." },
    { time: 134.0, text: "I can't describe..." }
  ];
  ...
  function createLoveExplosion(x, y) {
    ...
    const popup = document.createElement('div');
    popup.className = 'love-popup';
    popup.textContent = '💜 I love you endlessly, Trisha 💜';
